  ...
  "node_modules/@babylonjs/loaders/glTF/glTFFileLoader.js"() {
    ...
    GLTFFileLoader = function() {
      ...
      GLTFFileLoader2.prototype.canDirectLoad = function(data) {
        return data.indexOf("asset") !== -1 && data.indexOf("version") !== -1 || StringTools.StartsWith(data, "data:base64," + GLTFFileLoader2._MagicBase64Encoded) || StringTools.StartsWith(data, "data:;base64," + GLTFFileLoader2._MagicBase64Encoded) || StringTools.StartsWith(data, "data:application/octet-stream;base64," + GLTFFileLoader2._MagicBase64Encoded) || StringTools.StartsWith(data, "data:model/gltf-binary;base64," + GLTFFileLoader2._MagicBase64Encoded);
      };
      GLTFFileLoader2.prototype.directLoad = function(scene, data) {
        if (StringTools.StartsWith(data, "base64," + GLTFFileLoader2._MagicBase64Encoded) || StringTools.StartsWith(data, ";base64," + GLTFFileLoader2._MagicBase64Encoded) || StringTools.StartsWith(data, "application/octet-stream;base64," + GLTFFileLoader2._MagicBase64Encoded) || StringTools.StartsWith(data, "model/gltf-binary;base64," + GLTFFileLoader2._MagicBase64Encoded)) {
...
var init_glTFLoader = __esm({
  "node_modules/@babylonjs/loaders/glTF/1.0/glTFLoader.js"() {
    ...
    parseBuffers = function(parsedBuffers, gltfRuntime) {
    ...
    parseShaders = function(parsedShaders, gltfRuntime) {
    ...
    parseObject = function(parsedObjects, runtimeProperty, gltfRuntime) {
      for (var object in parsedObjects) {
        var parsedObject = parsedObjects[object];
        gltfRuntime[runtimeProperty][object] = parsedObject;
      }
    };
    normalizeUVs = function(buffer) {
      if (!buffer) {
        return;
      }
    ...
    getAttribute = function(attributeParameter) {
    ...
    loadAnimations = function(gltfRuntime) {
    ...
    configureBoneTransformation = function(node) {
      var mat = null;
    ...
    getParentBone = function(gltfRuntime, skins, jointName, newSkeleton) {
    ...
    getNodeToRoot = function(nodesToRoot, id) {
    ...
    getJointNode = function(gltfRuntime, jointName) {
      var nodes = gltfRuntime.nodes;
    ...
    nodeIsInJoints = function(skins, id) {
    ...
    getNodesToRoot = function(gltfRuntime, newSkeleton, skins, nodesToRoot) {
    ...
    importSkeleton = function(gltfRuntime, skins, mesh, newSkeleton) {
      if (!newSkeleton) {
    ...
    importMesh = function(gltfRuntime, node, meshes, id, newMesh) {
      if (!newMesh) {
        gltfRuntime.scene._blockEntityCollection = !!gltfRuntime.assetContainer;
    ...
    configureNode = function(newNode, position, rotation, scaling) {
      if (newNode.position) {
    ...
    configureNodeFromMatrix = function(newNode, node) {
      if (node.matrix) {
    ...
    importNode = function(gltfRuntime, node, id) {
      var lastNode = null;
    ...
    traverseNodes = function(gltfRuntime, id, parent, meshIncluded) {
    ...
    onBindShaderMaterial = function(mesh, gltfRuntime, unTreatedUniforms, shaderMaterial, technique, material, onSuccess) {
    ...
    prepareShaderMaterialUniforms = function(gltfRuntime, shaderMaterial, technique, material, unTreatedUniforms) {
      var materialValues = material.values || technique.parameters;
    ...
    onShaderCompileError = function(program, shaderMaterial, onError) {
      return function(effect, error) {
        shaderMaterial.dispose(true);
        onError("Cannot compile program named " + program.name + ". Error: " + error + ". Default material will be applied");
      };
    };
    onShaderCompileSuccess = function(gltfRuntime, shaderMaterial, technique, material, unTreatedUniforms, onSuccess) {
      return function(_) {
    ...
    parseShaderUniforms = function(tokenizer, technique, unTreatedUniforms) {
    ...
    importMaterials = function(gltfRuntime) {
...
var init_glTFBinaryExtension = __esm({
  "node_modules/@babylonjs/loaders/glTF/1.0/glTFBinaryExtension.js"() {
    ...
    GLTFBinaryExtension = function(_super) {
...
var init_glTFMaterialsCommonExtension = __esm({
  "node_modules/@babylonjs/loaders/glTF/1.0/glTFMaterialsCommonExtension.js"() {
    ...
    init_pointLight();
    init_spotLight();
    GLTFMaterialsCommonExtension = function(_super) {
...
var init_KHR_materials_iridescence = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_iridescence.js"() {
    ...
    KHR_materials_iridescence = function() {
...
var init_KHR_materials_emissive_strength = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_emissive_strength.js"() {
    init_pbrMaterial();
    init_glTFLoader2();
    NAME11 = "KHR_materials_emissive_strength";
...
var TransmissionHelper, NAME16, KHR_materials_transmission;
var init_KHR_materials_transmission = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_transmission.js"() {
    ...
    NAME16 = "KHR_materials_transmission";
...
var init_KHR_materials_translucency = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_translucency.js"() {
    init_pbrMaterial();
    init_glTFLoader2();
    NAME17 = "KHR_materials_translucency";
...
//# sourceMappingURL=chunk-Z6THR6ZU.js.map
